...
contract IPFSInbox {
    ...
    // A function that takes in the receiver's address and the IPFS address. Places the IPFS address in the receiver's inbox.
    ...
    // A function that checks your inbox and empties it afterwards. Returns an address if there is one, or "Empty Inbox"
    function checkInbox()
        public
    {
